...
In the Slalom ETL-Pipeline development lifecycle, the **Pull Request (PR)** is the "Gate" through which all code must pass. The **Squash Merge** is the "Polishing" step that keeps our project history clean and readable.
...
5.  **Review:** Ensure all CI checks (Fitness Functions, Tests) are green.
